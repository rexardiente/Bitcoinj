...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """bitcoinj""", """controllers.HomeController.bitcoinj"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_HomeController_bitcoinj1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("bitcoinj")))
  )
  private[this] lazy val controllers_HomeController_bitcoinj1_invoker = createInvoker(
    HomeController_0.bitcoinj,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "bitcoinj",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_HomeController_bitcoinj1_route(params) =>
      call { 
        controllers_HomeController_bitcoinj1_invoker.call(HomeController_0.bitcoinj)
      }
